...
export const Cylinder: React.FC<any> = ({
    resolution,
    showDifferentials,
    transparency,
    bounds,
    ...
    const geometry = useMemo(() => {
        return new THREE.CylinderGeometry(0.5, 0.5, 1, resolution, resolution);
    }, [resolution]);
    ...
    const scale = [
        Math.min(bounds.x[1] - bounds.x[0], bounds.y[1] - bounds.y[0]),
